Contributing to Vapexcoin Core
============================

The Vapexcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Vapexcoin Core project, and is not to be
confused with overall Vapexcoin Network Protocol consensus changes.

Whether a pull request is merged into Vapexcoin Core rests with the project merge
...
Patches that change Vapexcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Vapexcoin consensus, it must have been
...
The project leader is the release manager for each Vapexcoin Core release.
