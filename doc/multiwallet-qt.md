...
In order to support loading of multiple wallets in vapexcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vapexcoin.cpp.
...
Changes to vapexcoin.cpp
----------------------
vapexcoin.cpp is the entry point into vapexcoin-qt, and as such, will require some minor modifications to provide hooks for
