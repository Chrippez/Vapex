                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Vapexcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Vapexcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vapexcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zVAPEX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Vapexcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Vapexcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Vapexcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Vapexcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Vapexcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Vapexcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Vapexcoin Core help message to get a list with possible Vapexcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Vapexcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Vapexcoin network", "", count));
}
...
{
    QString strTitle = tr("Vapexcoin Core"); // default title
...
/** Creates context menu, its actions, and vapexcoins up all the relevant signals for mouse events. */
