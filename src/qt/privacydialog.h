...
public:
    ...
    void setZVapexcoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzVAPEX_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzVAPEX_clicked();
    void on_pushButtonZVapexcoinControl_clicked();
