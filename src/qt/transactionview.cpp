                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Vapexcoin from zVAPEX"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zVAPEX"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zVAPEX));
