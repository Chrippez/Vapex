...
/** Utility functions used by the Vapexcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Vapexcoin addresses in monospace font
...
// Parse "vapexcoin:" URI into recipient object, return true on successful parsing
