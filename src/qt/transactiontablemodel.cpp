...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Vapexcoin to zVAPEX");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zVAPEX");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Vapexcoin from zVAPEX");
    case TransactionRecord::ZerocoinSpend_Change_zVAPEX:
        return tr("Minted Change as zVAPEX from zVAPEX Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zVAPEX to Vapexcoin");
