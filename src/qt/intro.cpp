...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Vapexcoin Core"),
     ...
     * override -datadir in the vapexcoin.conf file in the default data directory
     * (to be consistent with vapexcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
