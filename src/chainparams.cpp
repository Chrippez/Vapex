...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("000003315f7adf6bc7b036370f4349c3c4f8f23e1bb26996d31154d9e26c9a1f"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1537251727, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("048c15283b80f80922d6fa8e92b0180775297a75e6ce66c411357ce13980578e37b569a057804cde525882c424dad8c77ff1c27aa4ee039b8b060c0b05aa2595a1");
        nDefaultPort = 8259;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Vapexcoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 90; // Vapexcoin: 1.5 minutes
        nTargetSpacingSlowLaunch = 10 * 60;  // Vapexcoin: 10 minutes (Slow launch - Block 288)
        nTargetSpacing = 1 * 60;  // Vapexcoin: 60 Seconds
        nMaturity = 15;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Vapexcoin new blockchain is here";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04e97cc4dd0fde6bb00bdd512acc3e302d9d69b57a1acd18abf8d0569a27d301f6982828295bdbeba0c0332fabc674403fb5fb40804954579e42e837694be43844") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1537251727;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2748691;

        
        hashGenesisBlock = genesis.GetHash();
        //MineGenesis(genesis);
        assert(hashGenesisBlock == uint256("000003315f7adf6bc7b036370f4349c3c4f8f23e1bb26996d31154d9e26c9a1f"));
        assert(genesis.hashMerkleRoot == uint256("44d663c43dad2a8460d3b00108b4a822e9a9e7a495d8f555ad98bd24b326d4f8"));
	    ...
	    strSporkKey = "0447e7fdec55b7ae1bf4d4de5d004bcfbc35e8fd882d919cd43931747cd618d00e79eaab0f49afe6d8d42a2adeb4d9b83d5529b4968326e4045dbe550497931ae0";
        strObfuscationPoolDummyAddress = "GfLRuhBWpz8N2Hp4t6zEmSKYEqL2dpmsqu";
        nStartMasternodePayments = 1537251727; // Tuesday, September 18, 2018 8:22:07 AM GMT+02:00
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("04e97cc4dd0fde6bb00bdd512acc3e302d9d69b57a1acd18abf8d0569a27d301f6982828295bdbeba0c0332fabc674403fb5fb40804954579e42e837694be43844");
        nDefaultPort = 51434;
        nEnforceBlockUpgradeMajority = 51;
        nRejectBlockOutdatedMajority = 75;
        nToCheckBlockUpgradeMajority = 100;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Vapexcoin: 1 day
        nTargetSpacing = 1 * 60;  // Vapexcoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet vapexcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet vapexcoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet vapexcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet vapexcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet vapexcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Vapexcoin: 1 day
        nTargetSpacing = 1 * 60;        // Vapexcoin: 1 minutes
