...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Vapexcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Vapexcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Vapexcoin features */
        {"vapexcoin", "masternode", &masternode, true, true, false},
        {"vapexcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"vapexcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vapexcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vapexcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vapexcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"vapexcoin", "startmasternode", &startmasternode, true, true, false},
        {"vapexcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vapexcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vapexcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vapexcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vapexcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vapexcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vapexcoin", "mnbudget", &mnbudget, true, true, false},
        {"vapexcoin", "preparebudget", &preparebudget, true, true, false},
        {"vapexcoin", "submitbudget", &submitbudget, true, true, false},
        {"vapexcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"vapexcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"vapexcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"vapexcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"vapexcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"vapexcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vapexcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vapexcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"vapexcoin", "mnsync", &mnsync, true, true, false},
        {"vapexcoin", "spork", &spork, true, true, false},
        {"vapexcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"vapexcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use vapexcoind, or the -server option to vapexcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> vapexcoin-cli " + methodname + " " + args + "\n";
}
