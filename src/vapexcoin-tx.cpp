...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Vapexcoin Core vapexcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  vapexcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vapexcoin transaction") + "\n" +
                               "  vapexcoin-tx [options] -create [commands]   " + _("Create hex-encoded vapexcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vapexcoin transaction
